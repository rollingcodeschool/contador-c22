const Teoria = () => {
  return (
    <section>
      ...
      <p>
        Uno de los conceptos clave en React son los componentes. <span className="parrafo-resaltado"> Un componente
        es una pieza reutilizable de la interfaz</span> de usuario que se encarga de
